...
% the Jacobian matrix of linearized system
J21_sym = jacobian(thetadd, theta);
J22_sym = jacobian(thetadd, thetad);
...
% the Jacobian around the operating point
J21 = subs(J21_sym, [theta1 theta2 theta3 thetad1 thetad2 thetad3 u1 u2 u3], [X_eq, U_eq]);
J21 = vpa(J21);
J22 = subs(J22_sym, [theta1 theta2 theta3 thetad1 thetad2 thetad3 u1 u2 u3], [X_eq, U_eq]);
J22 = vpa(J22);
